      ...
      <div className="lg:grid grid-cols-2">
        <div className="px-6 pb-24 pt-10 sm:pb-32 lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
            ...
            >
              Automate Your Success with AutomationNation
            </h1>
            <p
            ...
            >
              Don't spend countless hours on boring tasks. Focus on growing your business while we handle the automation. Our service provides marketing, sales, and admin automation, delivering efficiency and productivity.
            </p>
